...
ACTIONS: Mapping[ActionId, ActionDefinition] = MappingProxyType(
    {
        ...
        ActionId.CONFIRM_FOCUS: ActionDefinition(
            ActionId.CONFIRM_FOCUS, "Confirm", ConfirmFocus(), _idle
        ),
        ...
        ActionId.START_BREAK: ActionDefinition(
            ActionId.START_BREAK, "Start break", StartBreakIntent(), _has_break_offer
        ),
...
def navigate(
    runtime: RuntimeState,
    intent: OpenSetup | CycleDuration | BackHome,
    state: GameState,
    config: FocusConfig,
) -> RuntimeState:
